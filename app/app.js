...
const WOMEN = [
  ...
  { id:'w4', st:'o', mob:'f2', wish:'need', pay:'相手に出してもらいたい', cert:false, sim:{ok:false}, rng:{ok:true,st:'n'}, rnd:{ok:false,st:'o'}, name:'Rina',   age:26, img:'img/w4.jpg', best:118, ave:126, tier:'BRONZE', rounds:6,  rating:4.6, rc:5,  hist:'1〜3年', area:['埼玉','群馬'], dates:['7/12','7/21'], meet:'現地集合OK', drink:'少し飲む', style:'初心者歓迎でお願いします', reply:true,  bio:'ゴルフ歴2年目です。まだまだ下手ですが、一生懸命がんばります！' },
...
const TEE_DIST = {
  w1:{t:'車40分',ok:true}, w2:{t:'車95分',ok:false}, w3:{t:'車55分',ok:true}, w4:{t:'車70分',ok:false}, w5:{t:'拠点12km',ok:true},
  w6:{t:'車35分',ok:true}, w7:{t:'車80分',ok:false}, w8:{t:'車50分',ok:true}, w9:{t:'車65分',ok:false}, w10:{t:'車45分',ok:true},
...
V.tee = () => {
  ...
  <div class="page">
    <div class="tee-head">
      <header class="appbar green" style="padding-left:0;padding-right:0"><span class="ttl" style="text-align:left;font-size:18px">日程マッチ</span></header>
    ...
    <div class="tee-body">
      ...
      ${(S.myDates.length && missRows) ? `<div class="date-lbl" style="margin-top:4px"><span class="t">この日は合わないけど、あと一歩のお相手</span></div>${missRows}` : ''}
      ${(S.myDates.length && !rows && !compeCards && !missRows) ? `<div class="empty"><div class="big">—</div>この日はまだ候補がいません</div>` : ''}
      ${isD() ? '' : `
...
const STAMPS = [
  {id:'round', label:'ラウンド行きませんか？', chr:'ゴルフグリーン', cat:'inv', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 0) scale(.8)"><defs><clipPath id="gc1"><circle cx="100" cy="100" r="97"></circle></clipPath><linearGradient id="sky1" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#79cbee"></stop><stop offset="1" stop-color="#c9edfb"></stop></linearGradient><linearGradient id="grs1" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#7ccf57"></stop><stop offset="1" stop-color="#45a029"></stop></linearGradient></defs><circle cx="100" cy="100" r="97" fill="#eaf6f0"></circle><g clip-path="url(#gc1)"><rect width="200" height="200" fill="url(#sky1)"></rect><ellipse cx="52" cy="42" rx="27" ry="11" fill="#fff" opacity=".92"></ellipse><ellipse cx="150" cy="32" rx="20" ry="8" fill="#fff" opacity=".9"></ellipse><path d="M-2 118Q55 92 118 112Q166 126 202 112L202 202L-2 202Z" fill="#84d461"></path><path d="M-2 140Q70 116 150 138Q180 146 202 138L202 202L-2 202Z" fill="url(#grs1)"></path><rect x="126" y="60" width="3.4" height="94" rx="1.7" fill="#eef2ef"></rect><path d="M129 62L162 71L129 86Z" fill="#e23b3b"></path><ellipse cx="108" cy="152" rx="18" ry="7.4" fill="#2c6a1c"></ellipse><ellipse cx="108" cy="151" rx="12.5" ry="5" fill="#123008"></ellipse><circle cx="78" cy="150" r="12.6" fill="#fff"></circle><circle cx="78" cy="150" r="12.6" fill="none" stroke="#d7e5d8" stroke-width="1"></circle><g fill="#ccd8cd"><circle cx="75" cy="147" r="1"></circle><circle cx="80" cy="146" r="1"></circle><circle cx="82" cy="151" r="1"></circle><circle cx="76" cy="152" r="1"></circle></g></g><g class="spk"><use href="#spark" x="138" y="108" width="24" height="24" fill="#ffd23f"></use><use href="#spark" x="34" y="86" width="18" height="18" fill="#a06bff"></use></g></g><g transform="rotate(-3 100 176)"><text class="st" font-size="20" fill="#6a3fb0"><tspan x="100" y="166">ラウンド</tspan><tspan x="100" y="188">行きませんか？</tspan></text></g></svg>`},
  {id:'range', label:'打ちっぱなし行きませんか？', chr:'ダックフック', cat:'inv', svg:`<svg viewBox="0 0 200 200"><g transform="translate(30 -2) scale(.7)"><path d="M128 152Q180 116 158 62Q148 36 118 32" stroke="#7fb8ff" stroke-width="4" stroke-dasharray="1 10" fill="none" stroke-linecap="round"></path><circle cx="118" cy="32" r="9" fill="#fff" stroke="#d7e5d8" stroke-width="1"></circle><path d="M86 106L124 144" stroke="#8a9199" stroke-width="4" stroke-linecap="round"></path><path d="M124 144q11 7 3 13q-9 3 -12 -8Z" fill="#5b6770"></path><ellipse cx="74" cy="120" rx="30" ry="26" fill="#ffd23f"></ellipse><ellipse cx="79" cy="130" rx="16" ry="12" fill="#fff4cd"></ellipse><g stroke="#f0902a" stroke-width="3.2" stroke-linecap="round"><path d="M66 144l-2 10"></path><path d="M82 144l2 10"></path></g><ellipse cx="88" cy="106" rx="11" ry="7" fill="#f2c322" transform="rotate(42 88 106)"></ellipse><circle cx="66" cy="82" r="17" fill="#ffd23f"></circle><path d="M52 88q-15 -3 -19 4q7 6 19 3Z" fill="#f0902a"></path><circle cx="63" cy="83" r="2.4" fill="#241c12"></circle><path d="M52 74q3 -15 21 -13q7 2 9 9l-30 9Z" fill="#45a029"></path><rect x="38" y="72" width="22" height="5" rx="2.5" fill="#3f9724"></rect><g class="spk"><use href="#spark" x="152" y="142" width="16" height="16" fill="#ffd23f"></use><use href="#spark" x="32" y="36" width="15" height="15" fill="#a06bff"></use></g></g><g transform="rotate(-3 100 176)"><text class="st" font-size="20" fill="#3f9724"><tspan x="100" y="166">打ちっぱなし</tspan><tspan x="100" y="188">行きませんか？</tspan></text></g></svg>`},
  {id:'best', label:'ベストスコアはいくつですか？', chr:'クールシーガル', cat:'inv', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 4) scale(.8)"><path d="M40 122L72 108L76 130Z" fill="#fff" stroke="#e2ece9" stroke-width="1.4"></path><path d="M44 122l26 -10" stroke="#2fb6ab" stroke-width="4" stroke-linecap="round"></path><path d="M60 120Q64 84 104 86Q133 90 129 118Q124 140 96 140Q66 140 60 120Z" fill="#fff" stroke="#e2ece9" stroke-width="1.5"></path><g stroke="#3bbcae" stroke-width="4" stroke-linecap="round" fill="none"><path d="M74 112q22 -6 40 -2"></path><path d="M72 121q24 -4 44 0"></path><path d="M76 130q20 -2 38 2"></path></g><g stroke="#f0902a" stroke-width="3.6" stroke-linecap="round"><path d="M92 140l-3 16"></path><path d="M106 140l3 16"></path></g><g fill="#f0902a"><path d="M80 156l14 0 -7 6Z"></path><path d="M100 156l14 0 -7 6Z"></path></g><circle cx="114" cy="78" r="18.5" fill="#fff" stroke="#e2ece9" stroke-width="1.5"></circle><path d="M130 80l17 -2 -4 8 -13 3Z" fill="#f5972a"></path><path d="M130 84l13 1 -11 4Z" fill="#e0801a"></path><g fill="#232323"><rect x="101" y="72" width="12.5" height="8.4" rx="3.4"></rect><rect x="115.5" y="72" width="12" height="8.4" rx="3.4"></rect></g><path d="M113.5 75.5h2.2" stroke="#232323" stroke-width="2"></path><path d="M94 70Q114 48 134 70Q114 62 94 70Z" fill="#e2433a"></path><path d="M94 70q20 -7 40 0" stroke="#c5362e" stroke-width="3.4" fill="none" stroke-linecap="round"></path><circle cx="114" cy="50" r="4.2" fill="#fff"></circle><g class="spk"><use href="#spark" x="150" y="86" width="20" height="20" fill="#ffd23f"></use><use href="#spark" x="40" y="70" width="18" height="18" fill="#3bbcae"></use></g></g><g transform="rotate(-3 100 176)"><text class="st" font-size="20" fill="#2fb6ab"><tspan x="100" y="166">ベストスコアは</tspan><tspan x="100" y="188">いくつですか？</tspan></text></g></svg>`},
  {id:'night', label:'ナイター行く？', chr:'ナイターフクロウ', cat:'inv', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 0) scale(.8)"><defs><clipPath id="nc8"><circle cx="100" cy="100" r="97"></circle></clipPath></defs><circle cx="100" cy="100" r="97" fill="#20305c"></circle><g clip-path="url(#nc8)"><circle cx="150" cy="48" r="20" fill="#ffe58a"></circle><circle cx="141" cy="42" r="17" fill="#20305c"></circle><g fill="#fff" opacity=".85"><circle cx="40" cy="44" r="2"></circle><circle cx="64" cy="28" r="1.5"></circle><circle cx="170" cy="92" r="1.7"></circle><circle cx="30" cy="84" r="1.5"></circle></g><path d="M-2 158Q100 134 202 158L202 202 -2 202Z" fill="#2c5a3a"></path><rect x="98" y="92" width="3.4" height="66" rx="1.7" fill="#d9dee2"></rect><path d="M101 96L134 105 101 118Z" fill="#e23b3b"></path><circle cx="146" cy="166" r="7" fill="#fff"></circle><ellipse cx="100" cy="68" rx="20" ry="23" fill="#8a5a34"></ellipse><ellipse cx="100" cy="75" rx="12" ry="13" fill="#c99a6a"></ellipse><path d="M85 50l-5 -10 10 5Z" fill="#8a5a34"></path><path d="M115 50l5 -10 -10 5Z" fill="#8a5a34"></path><g fill="#ffe58a"><circle cx="92" cy="62" r="6.5"></circle><circle cx="108" cy="62" r="6.5"></circle></g><g fill="#241c12"><circle cx="92" cy="62" r="2.8"></circle><circle cx="108" cy="62" r="2.8"></circle></g><path d="M97 69l6 0 -3 5Z" fill="#f0902a"></path><g stroke="#f0902a" stroke-width="2.4" stroke-linecap="round"><path d="M94 89l0 5"></path><path d="M100 90l0 5"></path><path d="M106 89l0 5"></path></g></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="24" fill="#20305c">ナイター行く？</text></g></svg>`},
  {id:'revenge', label:'リベンジしよう', chr:'ブラックイーグル', cat:'inv', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 4) scale(.8)"><g fill="#161616"><path d="M96 96C40 96 34 44 74 40C52 52 60 78 92 74C58 66 66 40 96 52Z"></path><path d="M92 72C48 60 52 24 84 30C64 38 70 58 96 60Z"></path><path d="M100 108C60 116 40 92 60 78C60 96 84 96 100 90Z"></path><path d="M90 58C58 40 66 14 92 22C72 30 78 46 98 48Z"></path></g><path d="M96 58C108 34 152 40 152 76C152 92 138 100 118 100C100 100 86 88 96 58Z" fill="#fff" stroke="#e6ebe9" stroke-width="1.5"></path><path d="M96 58l-9 -8 11 2 -4 -11 9 8 3 -11 4 12 9 -5 -4 12Z" fill="#fff"></path><path d="M150 72l20 3 -8 13 -14 3Z" fill="#f6b41e"></path><path d="M152 86l14 2 -12 7Z" fill="#df9a10"></path><circle cx="128" cy="70" r="3.2" fill="#161616"></circle><g class="spk"><use href="#spark" x="150" y="118" width="18" height="18" fill="#ffd23f"></use><use href="#spark" x="52" y="120" width="16" height="16" fill="#7fb8ff"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="24" fill="#161616">リベンジしよう</text></g></svg>`},
  {id:'morning', label:'朝イチ集合！', chr:'モーニングルースター', cat:'inv', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 0) scale(.8)"><circle cx="158" cy="44" r="14" fill="#ffd23f"></circle><g stroke="#ffd23f" stroke-width="3" stroke-linecap="round"><path d="M158 22l0 -8"></path><path d="M178 34l6 -6"></path><path d="M182 50l8 0"></path><path d="M138 32l-6 -6"></path></g><ellipse cx="92" cy="152" rx="52" ry="8" fill="#d9efe2"></ellipse><g fill="#2e7d6b"><path d="M56 110q-24 -8 -28 -30q18 2 31 18Z"></path><path d="M56 122q-28 0 -38 -18q20 -2 37 8Z"></path></g><g stroke="#f0902a" stroke-width="3.2" stroke-linecap="round"><path d="M78 140l-2 14"></path><path d="M92 140l2 14"></path></g><g fill="#f0902a"><path d="M69 154l14 0 -7 5Z"></path><path d="M87 154l14 0 -7 5Z"></path></g><ellipse cx="84" cy="116" rx="30" ry="26" fill="#fff" stroke="#e2ece9" stroke-width="1.5"></ellipse><path d="M70 110Q66 94 86 92Q100 92 98 104Q96 116 82 118Q70 118 70 110Z" fill="#eef2ef"></path><circle cx="112" cy="78" r="15" fill="#fff" stroke="#e2ece9" stroke-width="1.5"></circle><g fill="#e2433a"><circle cx="105" cy="62" r="5"></circle><circle cx="112" cy="58" r="5.5"></circle><circle cx="119" cy="62" r="5"></circle></g><path d="M114 92q1 9 -5 12q-3 -7 1 -12Z" fill="#e2433a"></path><path d="M126 72l17 -5 -11 9Z" fill="#f0902a"></path><path d="M126 78l13 5 -14 1Z" fill="#e0801a"></path><circle cx="116" cy="71" r="2.4" fill="#241c12"></circle><g stroke="#c9d6e4" stroke-width="3" stroke-linecap="round"><path d="M148 62l10 -7"></path><path d="M150 72l12 -1"></path></g><g class="spk"><use href="#spark" x="36" y="48" width="18" height="18" fill="#ffd23f"></use><use href="#spark" x="156" y="110" width="15" height="15" fill="#a06bff"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="25" fill="#e2433a">朝イチ集合！</text></g></svg>`},
  {id:'nbirdie', label:'ナイスバーディ！', chr:'ロビン', cat:'nice', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 4) scale(.8)"><path d="M22 168Q100 178 186 156" stroke="#8a5a34" stroke-width="8" stroke-linecap="round" fill="none"></path><path d="M150 160l22 -14" stroke="#7a4e2c" stroke-width="5.5" stroke-linecap="round"></path><g stroke="#caa15f" stroke-width="3" stroke-linecap="round"><path d="M98 150l-3 16"></path><path d="M112 150l3 16"></path></g><path d="M50 128L86 116L88 140Z" fill="#6f6a5f"></path><path d="M76 132Q70 90 108 82Q147 80 147 120Q147 152 108 152Q82 152 76 132Z" fill="#8b8174"></path><path d="M92 134Q86 106 116 100Q141 100 141 122Q139 143 112 145Q96 145 92 134Z" fill="#736a5d"></path><path d="M90 150Q84 132 96 124Q107 122 111 133Q111 148 103 152Z" fill="#efe7d8"></path><path d="M106 151Q95 128 103 108Q112 90 133 95Q146 100 143 121Q140 140 132 151Q120 155 106 151Z" fill="#e87a2c"></path><circle cx="128" cy="106" r="3.1" fill="#241c12"></circle><path d="M142 110l15 1 -13 7Z" fill="#3a2f22"></path><g class="spk"><use href="#spark" x="46" y="70" width="18" height="18" fill="#ffd23f"></use><use href="#spark" x="150" y="60" width="16" height="16" fill="#7fb8ff"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="23" fill="#e87a2c">ナイスバーディ！</text></g></svg>`},
  {id:'fbirdie', label:'初バーディ！', chr:'プチバーディ', cat:'nice', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 0) scale(.8)"><ellipse cx="100" cy="178" rx="40" ry="6" fill="#0a2a12" opacity=".12"></ellipse><circle cx="100" cy="142" r="32" fill="#fff" stroke="#d7e5d8" stroke-width="1"></circle><g fill="#ccd8cd"><circle cx="90" cy="136" r="1.4"></circle><circle cx="102" cy="132" r="1.4"></circle><circle cx="112" cy="140" r="1.4"></circle><circle cx="94" cy="148" r="1.4"></circle><circle cx="106" cy="152" r="1.4"></circle></g><circle cx="90" cy="130" r="7" fill="#fff" opacity=".8"></circle><g stroke="#f0902a" stroke-width="2.6" stroke-linecap="round"><path d="M93 108l-2 5"></path><path d="M107 108l2 5"></path></g><circle cx="100" cy="88" r="24" fill="#8fd3ff"></circle><ellipse cx="100" cy="98" rx="13" ry="9" fill="#fff"></ellipse><path d="M78 84q-12 -4 -16 -14q12 0 21 8Z" fill="#5cb8f2"></path><path d="M122 84q12 -4 16 -14q-12 0 -21 8Z" fill="#5cb8f2"></path><path d="M100 64q-1 -9 5 -13" stroke="#5cb8f2" stroke-width="3" fill="none" stroke-linecap="round"></path><g fill="#241c12"><circle cx="92" cy="86" r="2.6"></circle><circle cx="108" cy="86" r="2.6"></circle></g><path d="M96 92l8 0 -4 6Z" fill="#f0902a"></path><g fill="#ffb3c8" opacity=".8"><circle cx="85" cy="93" r="3.4"></circle><circle cx="115" cy="93" r="3.4"></circle></g><g class="spk"><use href="#spark" x="146" y="60" width="18" height="18" fill="#ffd23f"></use><use href="#spark" x="38" y="70" width="15" height="15" fill="#ff8ab5"></use><use href="#spark" x="152" y="140" width="14" height="14" fill="#7fb8ff"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="26" fill="#2a86c2">初バーディ！</text></g></svg>`},
  {id:'turkey', label:'3連続バーディ！', chr:'ラッキーターキー', cat:'nice', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 0) scale(.8)"><ellipse cx="100" cy="158" rx="42" ry="6" fill="#0a2a12" opacity=".12"></ellipse><g transform="translate(100 126)"><path d="M0 0Q-10 -36 0 -58Q10 -36 0 0Z" transform="rotate(-63)" fill="#e2433a"></path><path d="M0 0Q-10 -36 0 -58Q10 -36 0 0Z" transform="rotate(-42)" fill="#f0902a"></path><path d="M0 0Q-10 -36 0 -58Q10 -36 0 0Z" transform="rotate(-21)" fill="#ffd23f"></path><path d="M0 0Q-10 -36 0 -58Q10 -36 0 0Z" fill="#ffe58a"></path><path d="M0 0Q-10 -36 0 -58Q10 -36 0 0Z" transform="rotate(21)" fill="#ffd23f"></path><path d="M0 0Q-10 -36 0 -58Q10 -36 0 0Z" transform="rotate(42)" fill="#f0902a"></path><path d="M0 0Q-10 -36 0 -58Q10 -36 0 0Z" transform="rotate(63)" fill="#e2433a"></path></g><g stroke="#f0902a" stroke-width="3" stroke-linecap="round"><path d="M92 148l-3 12"></path><path d="M108 148l3 12"></path></g><circle cx="100" cy="124" r="26" fill="#8a5a34"></circle><ellipse cx="100" cy="132" rx="15" ry="12" fill="#c99a6a"></ellipse><circle cx="100" cy="98" r="13" fill="#8a5a34"></circle><g fill="#241c12"><circle cx="95" cy="95" r="2.2"></circle><circle cx="105" cy="95" r="2.2"></circle></g><path d="M96 101l8 0 -4 6Z" fill="#f0902a"></path><path d="M100 103q-6 4 -4 13q7 -3 6 -11Z" fill="#e2433a"></path><g class="spk"><use href="#spark" x="36" y="46" width="18" height="18" fill="#ffd23f"></use><use href="#spark" x="148" y="44" width="18" height="18" fill="#ffd23f"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="23" fill="#e2433a"><tspan font-family="var(--font-num)" font-weight="700">3</tspan>連続バーディ！</text></g></svg>`},
  {id:'eagle', label:'ナイスイーグル！', chr:'ファイアイーグル', cat:'nice', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 4) scale(.8)"><defs><linearGradient id="fg3" x1="0" y1="1" x2="0" y2="0"><stop offset="0" stop-color="#ffd23f"></stop><stop offset=".5" stop-color="#ff8a1e"></stop><stop offset="1" stop-color="#f0500f"></stop></linearGradient></defs><g id="feagle3"><g fill="url(#fg3)"><path d="M2 8C-24 12 -32 -10 -20 -24C-18 -8 -6 -6 -3 -11C-7 3 8 2 2 8Z"></path><path d="M8 4C-10 -14 -4 -32 10 -30C3 -20 13 -13 15 -19C15 -4 22 -8 17 3Z"></path><path d="M-4 6C-18 -4 -15 -24 1 -27C-6 -14 5 -12 5 -18C2 -5 9 -4 -4 6Z"></path></g><path d="M4 -8C10 -22 30 -21 34 -7C36 2 30 8 21 8C10 8 1 5 4 -8Z" fill="#fff"></path><path d="M9 -15l-6 -7 8 3 -2 -9 6 6 3 -8 3 9 6 -4 -3 9Z" fill="#fff"></path><path d="M33 -5l13 -1 -4 7 -9 3Z" fill="#f6a623"></path><path d="M33 0l10 2 -8 3Z" fill="#d98812"></path><circle cx="19" cy="-6" r="2.3" fill="#20140a"></circle></g><use href="#feagle3" transform="translate(96 104) scale(1.05)"></use><use href="#feagle3" transform="translate(146 66) scale(.66)"></use><use href="#feagle3" transform="translate(60 138) scale(.72)"></use><g class="spk"><use href="#spark" x="150" y="120" width="18" height="18" fill="#ff5ea0"></use><use href="#spark" x="40" y="60" width="16" height="16" fill="#7fb8ff"></use><use href="#spark" x="120" y="40" width="15" height="15" fill="#ffd23f"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="23" fill="#f0500f">ナイスイーグル！</text></g></svg>`},
  {id:'albatross', label:'飛ばしていこう', chr:'アルバトロス', cat:'nice', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 4) scale(.8)"><g stroke="#8fd6f4" stroke-width="4" fill="none" stroke-linecap="round"><path d="M28 156q12 -8 24 0t24 0t24 0t24 0t24 0"></path><path d="M52 170q12 -7 24 0t24 0t24 0" opacity=".55"></path></g><path d="M100 104L16 66q4 14 20 18l64 14Z" fill="#f2f7fa"></path><path d="M16 66l20 9 -15 6Z" fill="#a9bccb"></path><path d="M100 100L184 46q-2 14 -18 20l-66 28Z" fill="#fff"></path><path d="M184 46l-17 11 15 8Z" fill="#a9bccb"></path><path d="M78 108l-22 10 5 -14Z" fill="#dfe9f0"></path><ellipse cx="104" cy="108" rx="30" ry="13" fill="#fff"></ellipse><circle cx="134" cy="100" r="11" fill="#fff"></circle><path d="M144 97l24 4q-11 9 -24 5Z" fill="#f2c04d"></path><circle cx="133" cy="96" r="2.2" fill="#241c12"></circle><g class="spk"><use href="#spark" x="46" y="120" width="18" height="18" fill="#7fd0ff"></use><use href="#spark" x="152" y="120" width="16" height="16" fill="#ffd23f"></use><use href="#spark" x="100" y="30" width="15" height="15" fill="#a06bff"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="24" fill="#2a86c2">飛ばしていこう</text></g></svg>`},
  {id:'condor', label:'いつかはコンドル', chr:'キングコンドル', cat:'nice', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 4) scale(.8)"><defs><linearGradient id="kc" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#54446e"></stop><stop offset="1" stop-color="#352a4e"></stop></linearGradient></defs><g fill="url(#kc)"><path d="M96 108Q54 100 20 66Q36 62 46 68Q40 46 52 36Q62 46 64 60Q68 40 82 34Q88 48 84 64Q96 54 106 58Z"></path><path d="M104 108Q146 100 180 66Q164 62 154 68Q160 46 148 36Q138 46 136 60Q132 40 118 34Q112 48 116 64Q104 54 94 58Z"></path></g><g fill="#352a4e"><path d="M86 146l-10 20 14 -9Z"></path><path d="M98 150l2 22 8 -20Z"></path><path d="M112 146l12 18 -2 -20Z"></path></g><ellipse cx="100" cy="122" rx="27" ry="30" fill="url(#kc)"></ellipse><ellipse cx="100" cy="130" rx="15" ry="17" fill="#6b5990"></ellipse><circle cx="100" cy="98" r="15" fill="#fff"></circle><circle cx="100" cy="86" r="12" fill="#f2bd9c"></circle><g fill="#241c12"><circle cx="95" cy="84" r="2.2"></circle><circle cx="105" cy="84" r="2.2"></circle></g><path d="M97 89q3 -2 6 0q0 6 -3 8q-3 -2 -3 -8Z" fill="#e8a13c"></path><path d="M89 73l3 -9 5 5 3 -8 3 8 5 -5 3 9Z" fill="#ffd23f" stroke="#e0a800" stroke-width="1"></path><g class="spk"><use href="#spark" x="152" y="104" width="20" height="20" fill="#ffd23f"></use><use href="#spark" x="28" y="110" width="16" height="16" fill="#a06bff"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="23" fill="#6a3fb0">いつかはコンドル</text></g></svg>`},
  {id:'okc', label:'OKください', chr:'グースネック', cat:'nice', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 0) scale(.8)"><ellipse cx="100" cy="158" rx="66" ry="9" fill="#d9efe2"></ellipse><circle cx="148" cy="146" r="10" fill="#fff" stroke="#d7e5d8" stroke-width="1"></circle><g fill="#ccd8cd"><circle cx="145" cy="143" r=".9"></circle><circle cx="150" cy="144" r=".9"></circle><circle cx="148" cy="149" r=".9"></circle></g><path d="M54 118l-20 -10 7 17Z" fill="#eef2ef" stroke="#e2ece9" stroke-width="1.2"></path><path d="M100 114Q104 58 132 58Q150 60 148 78Q147 92 138 100" stroke="#e2ece9" stroke-width="17.5" fill="none" stroke-linecap="round"></path><path d="M100 114Q104 58 132 58Q150 60 148 78Q147 92 138 100" stroke="#fff" stroke-width="14.5" fill="none" stroke-linecap="round"></path><ellipse cx="82" cy="128" rx="32" ry="24" fill="#fff" stroke="#e2ece9" stroke-width="1.5"></ellipse><path d="M68 116Q64 100 84 98Q98 98 96 110Q94 122 80 122Q70 122 68 116Z" fill="#eef2ef"></path><g stroke="#f0902a" stroke-width="3.4" stroke-linecap="round"><path d="M76 150l-2 8"></path><path d="M92 150l2 8"></path></g><circle cx="138" cy="100" r="10" fill="#fff" stroke="#e2ece9" stroke-width="1.5"></circle><path d="M141 108l9 18 -16 -8Z" fill="#f0902a"></path><circle cx="140" cy="98" r="2.2" fill="#241c12"></circle><g class="spk"><use href="#spark" x="44" y="56" width="18" height="18" fill="#ffd23f"></use><use href="#spark" x="162" y="84" width="15" height="15" fill="#7fb8ff"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="26" fill="#3f9724"><tspan font-family="var(--font-num)" font-weight="600">OK</tspan>ください</text></g></svg>`},
  {id:'wear', label:'ウェア新調した', chr:'グラムダチョウ', cat:'nice', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 4) scale(.8)"><defs><linearGradient id="ob2" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#5c2439"></stop><stop offset="1" stop-color="#3b1626"></stop></linearGradient></defs><g stroke="#ecbb90" stroke-width="4.6" stroke-linecap="round" fill="none"><path d="M88 138L83 184"></path><path d="M100 140L109 184"></path></g><g stroke="#e0a978" stroke-width="3.2" stroke-linecap="round"><path d="M83 184l-7 5M83 184l0 7M83 184l7 4"></path><path d="M109 184l-7 5M109 184l0 7M109 184l7 4"></path></g><g fill="#f3a9c6"><path d="M60 108q-22 -6 -30 -22q20 4 34 14Z"></path><path d="M62 120q-24 2 -36 -8q22 -2 38 -2Z"></path></g><path d="M70 96Q96 74 122 96Q135 112 124 135Q112 155 92 152Q67 150 60 128Q56 108 70 96Z" fill="url(#ob2)"></path><g fill="#491d2f"><circle cx="74" cy="146" r="9"></circle><circle cx="90" cy="150" r="9"></circle><circle cx="106" cy="146" r="9"></circle><circle cx="118" cy="135" r="8"></circle></g><path d="M96 100q26 -14 40 -6q-14 10 -30 16q-11 2 -10 -10Z" fill="#f4b0cb"></path><path d="M112 96Q120 70 132 60" stroke="#ecbb90" stroke-width="11" stroke-linecap="round" fill="none"></path><g fill="#f7bcd6"><circle cx="104" cy="96" r="8"></circle><circle cx="114" cy="92" r="8"></circle><circle cx="96" cy="100" r="7"></circle><circle cx="120" cy="100" r="7"></circle><circle cx="110" cy="104" r="7"></circle></g><path d="M124 74q10 4 12 12q-8 2 -14 -2Z" fill="#39b07a"></path><g fill="#d9f5e8"><circle cx="128" cy="80" r="1.3"></circle><circle cx="132" cy="84" r="1.3"></circle></g><ellipse cx="140" cy="58" rx="13" ry="11" fill="#f0c199"></ellipse><path d="M150 58l14 -3 -4 8Z" fill="#f0913c"></path><g fill="#ffd23f" stroke="#e0a800" stroke-width="1"><path d="M130 53q-5 -4 -10 -2q6 5 11 6Z"></path><ellipse cx="136" cy="55" rx="7" ry="5.2"></ellipse><ellipse cx="147" cy="54" rx="6.4" ry="5"></ellipse></g><g fill="#3a2b12"><ellipse cx="136" cy="55" rx="4.4" ry="3.4"></ellipse><ellipse cx="147" cy="54" rx="4" ry="3.2"></ellipse></g><g class="spk"><use href="#spark" x="108" y="20" width="26" height="26" fill="#a06bff"></use><use href="#spark" x="160" y="72" width="20" height="20" fill="#ffd23f"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="24" fill="#d9538a">ウェア新調した</text></g></svg>`},
  {id:'pond', label:'池ポチャした…', chr:'カワセミダイブ', cat:'course', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 0) scale(.8)"><g stroke="#8fd6f4" stroke-width="5" fill="none" stroke-linecap="round"><path d="M14 158q14 -8 28 0t28 0t28 0t28 0t28 0t28 0"></path><path d="M40 174q14 -7 28 0t28 0t28 0" opacity=".5"></path></g><g stroke="#7fd0ff" stroke-width="3.4" stroke-linecap="round"><path d="M126 140l-7 -12"></path><path d="M140 138l0 -14"></path><path d="M154 140l7 -12"></path></g><circle cx="140" cy="154" r="9" fill="#fff" stroke="#d7e5d8" stroke-width="1"></circle><g stroke="#c9d6e4" stroke-width="3" stroke-linecap="round"><path d="M30 40l14 12"></path><path d="M22 62l12 10"></path></g><g transform="translate(88 82) rotate(42)"><path d="M-22 -6l-16 -13 5 17Z" fill="#2a86c2"></path><ellipse cx="0" cy="0" rx="24" ry="14" fill="#39a8e0"></ellipse><ellipse cx="4" cy="7" rx="16" ry="8" fill="#f0902a"></ellipse><ellipse cx="-4" cy="-3" rx="13" ry="7" fill="#2a86c2" transform="rotate(-28)"></ellipse><circle cx="22" cy="3" r="11" fill="#39a8e0"></circle><circle cx="19" cy="9" r="3.6" fill="#fff"></circle><path d="M30 6l24 11 -26 3Z" fill="#2b2f36"></path><circle cx="24" cy="1" r="2.2" fill="#241c12"></circle></g><g class="spk"><use href="#spark" x="152" y="56" width="18" height="18" fill="#ffd23f"></use><use href="#spark" x="48" y="118" width="14" height="14" fill="#7fb8ff"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="24" fill="#2a86c2">池ポチャした…</text></g></svg>`},
  {id:'bunker', label:'砂遊び中…', chr:'サンドペリカン', cat:'course', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 0) scale(.8)"><defs><clipPath id="pp10"><path d="M128 78l42 2q-4 28 -25 26q-17 -2 -17 -28Z"></path></clipPath></defs><path d="M16 158Q100 118 184 158Q100 180 16 158Z" fill="#ecd39f"></path><g fill="#d9b877"><circle cx="60" cy="156" r="2"></circle><circle cx="128" cy="162" r="2"></circle><circle cx="96" cy="152" r="1.6"></circle></g><path d="M160 84L176 146" stroke="#8a5a34" stroke-width="4" stroke-linecap="round"></path><g stroke="#8a5a34" stroke-width="3" stroke-linecap="round"><path d="M168 146l16 -4"></path><path d="M172 144l1 8"></path><path d="M178 143l1 8"></path></g><g stroke="#f0902a" stroke-width="4" stroke-linecap="round"><path d="M78 136l-2 18"></path><path d="M94 136l2 18"></path></g><g fill="#f0902a"><path d="M68 154l16 0 -8 6Z"></path><path d="M88 154l16 0 -8 6Z"></path></g><ellipse cx="86" cy="110" rx="34" ry="28" fill="#fff" stroke="#e2ece9" stroke-width="1.5"></ellipse><path d="M70 104Q66 86 86 84Q100 84 99 96Q98 110 82 112Q70 112 70 104Z" fill="#eef2ef"></path><circle cx="116" cy="70" r="15" fill="#fff" stroke="#e2ece9" stroke-width="1.5"></circle><path d="M112 56q-1 -8 7 -11" stroke="#e2ece9" stroke-width="3" fill="none" stroke-linecap="round"></path><path d="M128 78l42 2q-4 28 -25 26q-17 -2 -17 -28Z" fill="#f6a94a"></path><g fill="#fff" clip-path="url(#pp10)"><circle cx="140" cy="94" r="7.5"></circle><circle cx="154" cy="92" r="7.5"></circle><circle cx="147" cy="102" r="7.5"></circle></g><path d="M128 70l44 6 -44 4Z" fill="#f0902a"></path><circle cx="111" cy="66" r="2.4" fill="#241c12"></circle><g class="spk"><use href="#spark" x="36" y="52" width="18" height="18" fill="#ffd23f"></use><use href="#spark" x="150" y="36" width="15" height="15" fill="#7fb8ff"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="26" fill="#c08a2e">砂遊び中…</text></g></svg>`},
  {id:'lost', label:'ボールなくした…', chr:'ボールさらいカラス', cat:'course', svg:`<svg viewBox="0 0 200 200"><g transform="translate(20 4) scale(.8)"><g stroke="#c9d6e4" stroke-width="3" stroke-linecap="round"><path d="M20 92h20"></path><path d="M16 108h16"></path><path d="M24 124h18"></path></g><path d="M92 96Q64 52 96 34Q96 58 106 72Z" fill="#3f3f3f"></path><path d="M112 96Q108 44 142 40Q130 62 128 82Z" fill="#232323"></path><path d="M78 116l-24 12 8 -18 16 -4Z" fill="#232323"></path><ellipse cx="104" cy="108" rx="32" ry="20" fill="#232323" transform="rotate(-8 104 108)"></ellipse><circle cx="160" cy="100" r="9.5" fill="#fff" stroke="#d7e5d8" stroke-width="1"></circle><g fill="#ccd8cd"><circle cx="157" cy="97" r=".9"></circle><circle cx="162" cy="98" r=".9"></circle><circle cx="160" cy="103" r=".9"></circle></g><circle cx="134" cy="96" r="14" fill="#232323"></circle><path d="M146 92l14 -4 -8 8Z" fill="#8a9199"></path><path d="M146 98l10 8 -14 0Z" fill="#767d85"></path><circle cx="137" cy="91" r="4.6" fill="#fff"></circle><circle cx="138" cy="92" r="2.2" fill="#241c12"></circle><g class="spk"><use href="#spark" x="60" y="150" width="16" height="16" fill="#ffd23f"></use><use href="#spark" x="150" y="52" width="15" height="15" fill="#a06bff"></use></g></g><g transform="rotate(-3 100 182)"><text class="st" x="100" y="190" font-size="23" fill="#454545">ボールなくした…</text></g></svg>`}
];
...
function openStampSheet(id){
  ...
  <div style="max-height:56dvh;overflow-y:auto;padding-bottom:4px">
  ${CATS.map(([cat,name])=>`
    <div class="sec-h" style="padding:8px 2px 6px"><span class="t" style="font-size:11.5px">${name}</span></div>
    <div class="stamp-grid">${STAMPS.filter(s=>s.cat===cat).map(s=>`
...
function certToggle(){
  const fid = S.fid || 'w1';
  const w = WOMEN.find(x=>x.id===fid); if(!w) return;
  S.fcert = S.fcert || {};
  S.fcert[fid] = !(w.cert !== false);
  w.cert = S.fcert[fid];
  ensureFset(); save(); render();
  toast(w.cert ? '認定ゴルファーに切替（デモ）' : '一般ゴルファーに切替（デモ）');
}
function lvCycle(){
  const cur = mlv();
  const top = S.role==='f' ? 3 : 4;
  const nx = cur >= top ? 1 : cur + 1;
  ...
  <div class="page">
    ...
    <div class="card" style="margin:16px 18px 0;padding:14px 16px">
      <div style="display:flex;align-items:center;gap:8px;margin-bottom:9px">
        ...
        <span class="chip ${r.st==='o'?'brass':''}" style="font-size:9px">${r.st==='o'?'おもてなし':'仲間探し'}</span>
        <span class="chip line" style="font-size:9px;margin-left:auto">${cert?'認定':'一般'}</span>
      </div>
      <div style="display:flex;gap:8px">
        ${[['n','仲間探し','謝礼なし・割り勘前提'],['o','おもてなし','謝礼つきオファーで受ける']].map(([k,t,s])=>`
        <button class="venue-row ${r.st===k?'on':''}" style="flex:1" onclick="ensureFset();S.fset.rnd.st='${k}';save();render()">
          <span class="vn">${t}</span><span class="vt">${s}</span>
        </button>`).join('')}
      </div>
      ${r.st==='o'?`<p class="muted" style="font-size:10.5px;margin-top:9px">ラウンド成立ごとの受取は <b>¥${cert?'17,600':'4,400'}</b>（${cert?'認定':'一般'}・固定）</p>`:''}
...
function gpTap(){
  ...
  if(gp.state==='dir'){
    if(!gp.bonusMode && gp.left<=0){ gpRefill(); return; }
    cancelAnimationFrame(gp.raf); gpPower(); return;
  }
  if(gp.state!=='aim') return;
  gp.state='roll'; cancelAnimationFrame(gp.raf);
  if(!gp.bonusMode) gp.left--;
...
function gpCupIn(fromRim, showR, o){
  ...
  if(gp.bonusMode){
    showR(fromRim?'ぐるっと回って…カップイン！':'ナイスパット！カップイン', 'in');
    gp.state='done';
    setTimeout(()=>bonusFinish(true), 900);
    return;
  }
...
function gpDone(){
  gp.state='done';
  const b=document.getElementById('gp-btn'); if(b) b.textContent='次の1打へ';
  if(gp.bonusMode){ setTimeout(()=>bonusFinish(false), 900); }
}
